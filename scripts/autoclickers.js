let Autoclickers = {
  ...
  OldButtons: '',
  nbrOwned: {
    'clickers': {cost:50, number: 0, cps: 1.5, buttonString: 'Clicker', showing: false, state: ''},
    'trainedclickers': {cost:200, number:0, cps:7.5, buttonString: 'Trained Clicker', showing: false, state: ''},
    'spammers': {cost:1000, number:0, cps:30, buttonString: 'Spammer', showing: false, state: ''},
    'tappers': {cost:20000, number:0, cps:200, buttonString: 'Tapper', showing: false, state: ''},
    'vibrationengineers': {cost: 100000, number:0, cps:1200, buttonString: 'Vibration Engineer', showing: false, state: ''},
    'collegedropouts': {cost:1500000, number:0, cps:25000, buttonString: 'College Dropout', showing: false, state: ''},
    'babies': {cost:20000000, number:0, cps:700000, buttonString: 'Baby', showing: false, state: ''},
    'bossbabies': {cost:150000000, number:0, cps:2500000, buttonString: 'Boss Baby', showing: false, state: ''},
    ...
    'prestigeclicker': {cost:7e16, number:0, cps:5e14, buttonString: 'Prestige Clicker', showing: false, state: ''},
...
`
    ...
    if (this.nbrOwned.developers.number > 0){
      textstring += `\n\
<button title='+50% (+??%) Bonus' style='font-family:monospace; margin:1px 0' onclick='Prestige.prestige()'>Prestige</button>`
      }
