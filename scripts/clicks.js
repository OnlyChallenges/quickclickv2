var Clicks = {
	...
	onload() {
		...
		document.getElementById('mouseupgrades').innerHTML = 'Mouse Rating: ' + abbreviate((this.mouseUpgrades)) + ' (+ ' + abbreviate((Prestige.bonus)) + '%)' 
	...
	setNbrOwned(value) {
		...
		document.getElementById('clicks').innerHTML = 'Clicks: ' + abbreviate(Math.floor(value))
	},
